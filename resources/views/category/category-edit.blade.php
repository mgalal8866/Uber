    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
                <img src="{{  $image?->temporaryUrl() ?? ($imageorginal !=null?  $imageorginal :'../../assets/img/no-image.png') }}" alt="user-avatar" class="d-block w-px-100 h-px-100 rounded"
                    id="uploadedAvatar" />
                <div class="button-wrapper">
                    ...
                    <button type="button" wire:click="fileClear('image')" class="btn btn-label-secondary account-image-reset mb-3">
